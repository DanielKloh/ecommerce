...
class Cart extends Model
{
	...
	public function addProduc(Products $product)
	{
	...
	public function removeProduc(Products $product, $all = false)
	{
	...
	public function getValues(){
		$this->getCalcolateTotal();

		return parent::getValues();
	}


	public function getCalcolateTotal(){
